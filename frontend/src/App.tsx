            ...
            >
              <Routes>
                ...
                <Route
                  ...
                  element={<div>Processing Google authentication...</div>}
                />
                <Route
                  path="/compress"
                  element={
                        ...
                        <Container maxWidth="lg" sx={{ py: 4, width: "100%" }}>
                          ...
                          >
                            ...
                            <Typography
                              ...
                              sx={{ mb: 6, maxWidth: "800px", mx: "auto", color: currentTheme.palette.mode === "dark" ? "white" : "black",}}
                            >
                              Advanced Network Data Compression for Optimized
                              Performance
                            </Typography>
                          </motion.div>
